Data set (1)
nM (Number of measurements) = 20000
Mph (Number of photons) = 10
b ( number of bins)
...
d1= std(T1) % Standard deviation of the mean fidelity estimation times (rhoML2, rho)
d2= std(T2) %Standard deviation of the mean fidelity estimation times (rhohistogram, rho)
