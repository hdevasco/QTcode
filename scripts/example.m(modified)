...
x = samples(:,2);% Uses the quadrature values to group them into quantities of bins to be determined
[counts,centers] = hist(x)% Count how many numbers are in each of the bins and returns the count of the bins and the centers of the deposits.
[N,edges] = histcounts(x,1000)%Distribute second colun of samples into 1000 equally spaced bins.
