...
% Por causa da dimensão das amostras, o número de medições deve ser maior ou igual 
% que o número máximo de bins(b)*número de fases igualmente espaçadas(m).

% Because of the size of the samples, the number of measurements should be greater than or equal to 
% the maximum number of bins (b) * number of equally spaced phases (m).
