 ...
 for i=1:length(maxPhotonNumber),
    for k=1:length(alpha),
         for j=1:length(deltaq),
            ...
            fileName1 = ['maxPhNum',num2str(maxPhotonNumber(i)),'BinWidth',num2str(deltaq(j)),'alpha',num2str(alpha(k)),'.mat'];
